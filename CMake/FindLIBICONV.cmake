...
if (LIBICONV_JUST_WORKS)
  ...
  libfind_pkg_search_modules (LIBICONV_PKGCONF iconv libiconv libiconv-2 libiconv2 c)
  ...
  find_path (LIBICONV_INCLUDE_DIR NAMES iconv.h HINTS ${LIBICONV_PKGCONF_INCLUDE_DIRS} ${LIBICONV_PKGCONF_INCLUDEDIR})
  find_library (LIBICONV_LIBRARY NAMES iconv libiconv libiconv-2 libiconv2 c HINTS ${LIBICONV_PKGCONF_LIBRARY_DIRS})

  # Set the LIBICONV_PROCESS_ variables and call libfind_process to wrap it all up and report
