...
tbb::tick_count features_file_parsed_time = tbb::tick_count::now();
	...
	FeatureExtractor feature_extractor(n_regular_properties, regex_properties, word_to_enum_props);
...
tbb::tick_count all_done_time = tbb::tick_count::now();
	...
	report_time("Total time", (all_done_time - start_time).seconds());
	report_time("Total init time", (pipeline_initialized_time - start_time).seconds());
	report_time("Total computation time", (all_done_time - pipeline_initialized_time).seconds());
	report_time("Parsing options", (options_parsed_time - start_time).seconds());
	report_time("Config file lookup", (config_files_found_time - options_parsed_time).seconds());
	report_time("Rough tokenizer compilation", (roughtok_compiled_time - config_files_found_time).seconds());
	report_time("Rough tokenizer loading", (roughtok_loaded_time - roughtok_compiled_time).seconds());
	report_time("Regular expression property compilation", (regex_properties_compiled_time - roughtok_loaded_time).seconds());
	report_time("Enumerated property compilation", (enum_properties_compiled_time - regex_properties_compiled_time).seconds());
	report_time("Parsing features file", (features_file_parsed_time - enum_properties_compiled_time).seconds());
	report_time("Pipeline construction", (pipeline_initialized_time - features_file_parsed_time).seconds());
