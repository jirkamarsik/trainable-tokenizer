...
find_path (MaxEnt_INCLUDE_DIR NAMES maxentmodel.hpp PATH_SUFFIXES maxent HINTS ${MaxEnt_PKGCONF_INCLUDE_DIRS} ${MaxEnt_PKGCONF_INCLUDEDIR})
find_library (MaxEnt_LIBRARY NAMES maxent HINTS ${MaxEnt_PKGCONF_LIBRARY_DIRS})

# Set the MaxEnt_PROCESS_ variables and call libfind_process to wrap it all up and report
